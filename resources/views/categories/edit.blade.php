    ...
    <section class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm font-bold text-slate-500">Perbarui kategori buku</p>
            </div>
        </div>
        ...
        <form action="{{ route('categories.update', $category) }}"
            ...
            <div>
                <label class="mb-2 block text-sm font-black">Nama Kategori</label>
                <input type="text"
                       name="name"
            ...
            <div>
                <label class="mb-2 block text-sm font-black">Icon Lucide</label>
                <input type="text"
                       name="icon"
                       value="{{ old('icon', $category->icon) }}"
                       class="w-full rounded-2xl border-0 bg-lime-50 px-4 py-3 font-bold">
                <p class="mt-1 text-xs font-bold text-slate-400">
                    Contoh: book-open, scale, tags, library, scroll-text
                </p>
            </div>

            <div>
                <label class="mb-2 block text-sm font-black">Deskripsi</label>
                <textarea name="description"
                          rows="4"
                          class="w-full rounded-2xl border-0 bg-lime-50 px-4 py-3 font-bold">{{ old('description', $category->description) }}</textarea>
            </div>
